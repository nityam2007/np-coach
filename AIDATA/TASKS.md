...
- ✅ **Client review (2026-08-20)** — all six review slides implemented with the approved Drive media pack: homepage video/globe/school/stats/accreditations, 21:9 banners and compliance download, tour icons/cards/heroes/alternating sections, filtered anchored route selectors, fleet showcase, and rounded footer with verified social links. Directus fields and one-time media revision are additive and CMS-safe.
- **Remaining:** production acceptance in [../HANDOVER.md](../HANDOVER.md), Microsoft 365 delivery, required 301 redirects, off-site restore-tested backups, final live integrations/QA, and exact image pins before the standalone Traefik alternative is used.
