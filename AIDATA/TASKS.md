...
- ✅ **Contact/quote delivery repair (2026-08-31)** — both lead forms now persist through the private Directus extension, then use separate customer/staff row-locked delivery channels and private maintenance discovery. This removes the create-only app-role/read mismatch, MariaDB ISO timestamp CAS failure, and stale static Server Action page risk.
