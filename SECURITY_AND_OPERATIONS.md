...
- Contact and quote records are persisted before email. A bounded maintenance retry worker uses atomic delivery leases; CMS-paid booking/pass reconciliation and payment/lead delivery failures are retried and remain visible in Directus.
