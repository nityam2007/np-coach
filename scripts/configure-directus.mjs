...
const COLLECTION_META = {
  ...
  service_runs: {
    ...
    note: "Seat inventory for a specific route, date and departure. A row is created automatically when the first customer starts checkout; an empty list is normal before online sales begin.",
  },
  pass_purchases: {
    group: "grp_orders",
    sort: 3,
...
const FIELD_META = {
  ...
  service_runs: [
    ...
    { field: "capacity", meta: { width: "half", note: "Sellable seats for this departure. Do not reduce it below Booked seats." } },
