...
const SCHEDULED_SERVICES_FIELDS = [
  ...
  json("operating_days"),
  { field: "capacity", type: "integer", meta: { interface: "input", options: { min: 1, max: 500 }, note: "Default sellable seats copied into each dated run; combine seats for multiple buses." }, schema: { default_value: 0 } },
  json("stops"),
  json("fares"),
  text("notice"),
];
...
const SERVICE_RUNS_FIELDS = [
  ...
  str("departure_time"),
  { field: "capacity", type: "integer", meta: { interface: "input", options: { min: 1, max: 500 }, note: "Dated capacity; may override the default for extra/larger buses." }, schema: {} },
